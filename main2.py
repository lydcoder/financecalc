...
def save_as_pdf():
    ...
    rendered = render_template_string(open('BAK2index.html', 'r').read())

    # Create a temporary file for the PDF
    pdf_path = tempfile.mktemp(suffix=".pdf")
    rendered = render_template('pdf_temp.html')

    # Convert the rendered HTML to PDF
    pdfkit.from_string(rendered, pdf_path)

    # Send the PDF file to the user
    return send_file(rendered,pdf_path, as_attachment=True, attachment_filename='page.pdf')    
"""